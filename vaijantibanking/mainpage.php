...
<html>
    ...
    <title>Sparks Trust Bank by Vaijanti</title>
    ...
    <!-- Carousel -->
        ...
        <div class="carousel-item active">
            <img src="imgs/mainbank.jpeg" alt="Bank" class="d-block" style="width:100%" height="100%">
            <div class="carousel-caption">
            <h3>Sparks Trust Bank </h3>
            <p>Your trust, our Responsibility!</p>
            </div>
        </div>
        <div class="carousel-item">
            <img src="imgs/atm4.jpg" alt="Chicago" class="d-block" style="width:100%">
            <div class="carousel-caption">
        ...
        <div class="carousel-item">
            <img src="imgs/online.jpg" alt="New York" class="d-block" style="width:100%">
            <div class="carousel-caption">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <img src="imgs/banke.jpg" class="img-fluid" data-aos="fade-up" data-aos-duration="2000" data-aos-offset="100">
                </div>
                <!-- Services Buttons -->
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12" data-aos="fade-left" data-aos-duration="2000" data-aos-delay="500" data-aos-offset="100">
                    <img src="imgs/bank.jpg" height="100%" width="100%">
                </div>
